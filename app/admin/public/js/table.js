...
export function renderTable() {
    ...
    const mappingPage = {
      "index": null,
      "user-management": { role: "user", rowsPerPage: 5 , data: users},
      "participant-player-management": { role: "participant_player", rowsPerPage: 5 , data : participants.players},
      "participant-team-management": { role: "participant_team", rowsPerPage: 5 , data : participants.teams},
      "tournament-management": { role: "tournament", rowsPerPage: 5 , data : tournaments},
      "game-management": { role: "game", rowsPerPage: 5 , data : games},
      "news-management": { role: "news", rowsPerPage: 5 , data : news},
      "highlight-management": { role: "highlight", rowsPerPage: 5 , data : highlights},
      "rule-management": { role: "rule", rowsPerPage: 5 , data : rules},
      "match-players-management": { role: "player_match", rowsPerPage: 5 , data : player_matches},
      "match-teams-management": { role: "team_match", rowsPerPage: 5 , data : team_matches}
    };
