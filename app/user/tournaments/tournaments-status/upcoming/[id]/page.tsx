...
import { Facebook, Twitter, Instagram, X, Heart, Calendar, Clock, MapPin, Users } from 'lucide-react'
    ...
    >
      <div className="min-h-screen bg-gradient-to-br from-[#0F0F23] via-[#1A1A2E] to-[#16213E] p-6">
        ...
        <div className="w-full px-8 mb-12">
          <div className="relative w-full h-[600px] rounded-[27px] border border-[#F59E0B] overflow-hidden" 
               style={{ filter: 'drop-shadow(0px 10.57px 42.3px rgba(245, 158, 11, 0.2))' }}>
            ...
            <div className="absolute top-8 right-8 bg-gradient-to-r from-[#F59E0B] to-[#D97706] rounded-xl shadow-lg px-6 py-2">
        ...
        <div className="w-full px-8 my-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-gradient-to-r from-[#2A2A4A] to-[#1E1E3F] border-[#F59E0B] shadow-[0px_9.18px_36.7px_rgba(245,158,11,0.2)]">
