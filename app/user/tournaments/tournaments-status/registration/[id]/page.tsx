...
import { Facebook, Twitter, Instagram, X, Heart, Calendar, Clock, MapPin, Users, DollarSign } from 'lucide-react'
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0F0F23] via-[#1A1A2E] to-[#16213E] p-6">
        ...
        <div className="w-full px-8 my-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-gradient-to-r from-[#2A2A4A] to-[#1E1E3F] border-[#10B981] shadow-[0px_9.18px_36.7px_rgba(16,185,129,0.2)] rounded-[23px]">
              <CardContent className="p-8 h-full flex flex-col">
                <h2 className="text-white font-bold text-4xl mb-8">Tournament Information</h2>
                {/* Prize Pool */}
                <div className="mb-6">
                  <p className="text-[#A5B4FC] text-base mb-1">Prize Pool</p>
                  <p className="text-white font-semibold text-2xl">{tournament?.prizePool || '$2,000,000'}</p>
                </div>
                {/* Participants */}
                <div className="mb-6">
                  <p className="text-[#A5B4FC] text-base mb-1">Participants</p>
                  <p className="text-white font-semibold text-2xl">{tournament?.participants || '16'}</p>
                </div>
                {/* Format */}
                <div className="mb-6">
                  <p className="text-[#A5B4FC] text-base mb-1">Format</p>
                  <p className="text-white font-semibold text-2xl">{tournament?.format || 'Double Elimination'}</p>
                </div>
                {/* Duration */}
                <div className="mb-6">
                  <p className="text-[#A5B4FC] text-base mb-1">Duration</p>
                  <div className="flex items-center gap-2">
                    <span className="text-white font-semibold text-2xl">{tournament?.startDate || 'Dec 15, 2024'}</span>
                    <span className="text-white font-semibold text-2xl">-</span>
                    <span className="text-white font-semibold text-2xl">{tournament?.endDate || 'Dec 22, 2024'}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-r from-[#2A2A4A] to-[#1E1E3F] border-[#10B981] shadow-[0px_9.18px_36.7px_rgba(16,185,129,0.2)] rounded-[23px]">
              <CardContent className="p-8 h-full flex flex-col">
                <h2 className="text-white font-bold text-4xl mb-8">About Tournament</h2>
                {/* Description */}
                ...
                <div className="mb-8">
                  ...
                  <p className="text-white font-semibold text-xl">{tournament?.organizer || 'Riot Games'}</p>
                </div>
                {/* Registration and Follow Buttons */}
                <div className="flex gap-4 mt-auto">
                  <Button
                    className="bg-gradient-to-r from-[#3D5AF1] to-[#10B981] hover:from-[#2563EB] hover:to-[#059669] text-white font-medium px-10 py-4 rounded-xl text-lg shadow-[0px_4.59px_18.35px_rgba(61,90,241,0.4)]"
                    onClick={() => {
